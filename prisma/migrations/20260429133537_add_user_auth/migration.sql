/*
  ...
  - Added the required column `userId` to the `SeoAnalysis` table without a default value. This is not possible if the table is not empty.

*/
-- AlterTable
ALTER TABLE "SeoAnalysis" ADD COLUMN     "userId" TEXT NOT NULL;
